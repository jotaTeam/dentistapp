...
export const Home = () => {
    return (
        ...
        <p className='home-description'>Servicio de cita previa y urgencias en tu clínica dental de confianza</p>
        </div>
